...
const AllAnnouncementsTableRow = ({
  announcement,
  deleteAnnouncement,
  editAnnouncement,
  clearDeleteAnnouncementErrorMessage,
  ...
  return (
    <tr>
      ...
      <td>
        <div className="d-flex align-items-center">
          {announcement.type
            ? intl.formatMessage({ id: announcement.type.toUpperCase() })
            : renderEmpty()}
        </div>
      </td>
      <td>
...
const mapDispatchToProps = dispatch => ({
  deleteAnnouncement: (announcementUuid, messages) =>
    dispatch(deleteAnnouncementAsync(announcementUuid, false, messages)),
  editAnnouncement: (requestBody, announcementUuid, messages) =>
    dispatch(
      editAnnouncementAsync(requestBody, announcementUuid, false, messages)
    ),
  clearDeleteAnnouncementErrorMessage: () =>
