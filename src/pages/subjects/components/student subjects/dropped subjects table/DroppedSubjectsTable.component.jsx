...
import DroppedSubjectsTableRow from "./DroppedSubjectsTableRow.component"
...
const DroppedSubjectsTable = ({
  ...
  const tableAttributes = {
    ...
    table: {
      ...
      row: subject => <DroppedSubjectsTableRow subject={subject} />,
    },
    givenArray: filteredSubjects,
    title: intl.formatMessage({ id: "DROPPED.SUBJECTS" }),
    emptyMessage: intl.formatMessage({ id: "NO.DROPPED.SUBJECTS.YET" }),
  }
