...
import PendingSubjectsTableRow from "./PendingSubjectsTableRow.component"
...
const PendingSubjectsTable = ({
  ...
  const tableAttributes = {
    ...
    table: {
      ...
      row: subject => <PendingSubjectsTableRow subject={subject} />,
    },
    givenArray: filteredSubjects,
    title: intl.formatMessage({ id: "PENDING.SUBJECTS" }),
    emptyMessage: intl.formatMessage({ id: "NO.PENDING.SUBJECTS.YET" }),
  }
