...
import CompletedSubjectsTableRow from "./CompletedSubjectsTableRow.component"
  ...
  const tableAttributes = {
    ...
    table: {
      columns: [
        ...
        {
          title: intl.formatMessage({ id: "PASSED/FAILED" }),
        },
        {
          title: intl.formatMessage({ id: "TYPE" }),
        },
      ],
      row: subject => <CompletedSubjectsTableRow subject={subject} />,
    },
